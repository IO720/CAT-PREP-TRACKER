const rawIcons = {
  Logo: ({ size = 20, className = "" }) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round" className={className}>
      <path d="M17 7.5C15.2 5.5 12.8 4.5 10 5C6.5 5.6 4 8.7 4 12.3C4 16 7 19 11 19C14 19 16.5 17.5 18 15" />
      <path d="M12 6L19 9L15 10.5L18 14L13 11L15 9.5L12 6Z" fill="currentColor" strokeWidth="1" />
  ...
  Flame: ({ size = 16, className = "", color = "currentColor" }) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill={color === "currentColor" ? "none" : color} stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
  ...
  Puzzle: ({ size = 16, className = "" }) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
      <path d="M19.439 7.85c-.049-.322-.059-.66-.029-1.002.106-1.226.962-2.224 2.124-2.502a.64.64 0 0 0 .466-.628V3.25A1.25 1.25 0 0 0 20.75 2h-.468c-.342.03-.68.02-1.002-.029-1.226-.106-2.224-.962-2.502-2.124A.64.64 0 0 0 16.15-.62H15.68A1.25 1.25 0 0 0 14.43.63v.468c-.03.342-.02.68.029 1.002.106 1.226.962 2.224 2.124 2.502.264.064.453.272.466.544v3.704"></path>
  ...
  Key: ({ size = 16, className = "" }) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
      <path d="M21 2l-2 2m-1.5 1.5L14 9m-1.5 1.5l-4.5 4.5a5 5 0 1 1-7.07-7.07l4.5-4.5m1.5-1.5L9 2"></path>
    </svg>
  ),
  Cloud: ({ size = 16, className = "" }) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
  ...
  Sparkles: ({ size = 16, className = "", color = "currentColor" }) => (
...
// Safe Proxy so any unregistered icon gracefully falls back instead of throwing undefined
export const Icons = new Proxy(rawIcons, {
  get: (target, prop) => {
    if (prop in target) return target[prop];
    return target.Trophy || target.Sparkles;
  }
});
