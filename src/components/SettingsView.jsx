...
import { signUpUser, logInUser, logOutUser, getLocalAspirantId } from '../utils/firebase';
    ...
    <div className="settings-page-wrapper fade-in">
      ...
      <div className="settings-cards-grid">
        ...
        <div className="settings-card-container">
          ...
          <div className="settings-card-body">
            {/* 9 Emblem Buttons displaying ONLY the theme logos */}
              ...
              {THEMES.map((th) => {
                ...
                return (
                  <button
                    key={th.id}
                    type="button"
                    className={`settings-theme-emblem-btn ${isActive ? 'active' : ''} ${isHovered ? 'hovered' : ''}`}
